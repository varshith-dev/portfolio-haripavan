...
const buildGrid = ({ width, height, pixelSize, gap, pattern, randomness }: BuildGridParams) => {
  let size = pixelSize;
...
interface BuildKeyframesParams {
...
const buildKeyframes = ({ ease, startScale, endScale, spin, fade }: BuildKeyframesParams) => {
